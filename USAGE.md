...
| ----------------------- | ---------- | ------------- | ---------------------------------------------------------------------------------------------------------------------- |
| `host`                  | `String`   | `localhost`   | prompt user to enter on screen if not provided and `prompt=true`                                                       |
| `port`                  | `integer`  | `22`          |                                                                                                                        |
| `username`              | `String`   |               | prompt user to enter on screen if not provided and `prompt=true`                                                       |
| `password`              | `String`   |               | prompt user to enter on screen if not provided and `prompt=true`                                                       |
| `remotePath`            | `String`   | `.`           | prompt user to enter on screen if not provided and `prompt=true`                                                       |
| `localPath`             | `String`   | `.`           | prompt user to enter on screen if not provided and `prompt=true`                                                       |
...
| `prompt`                | `boolean`  | `false`       | Prompt on console if value is missing, applicable to fields `username`, `password`, `host`, `localPath`, `remotePath`. |
