...
exports.init = function (workingObject, remoteFileObject, n) {
  ...
  return new Promise((resolve, reject) => {
    const fileWorkingObject = {
      ...
      postProcessingOptions: option.postProcessingOptions
    }
...
exports.postProcessing = function (fileWorkingObject) {
  return new Promise((resolve, reject) => {
    try {
      if (fileWorkingObject.postProcessing !== null) {
        fileWorkingObject.postProcessing(
          fileWorkingObject.localFile,
          fileWorkingObject.remoteFileObject,
          fileWorkingObject.postProcessingOptions)
      }
      resolve(fileWorkingObject)
    } catch (e) {
      reject(e)
