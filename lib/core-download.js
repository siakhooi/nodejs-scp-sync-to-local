...
exports.init = function (workingObject, remoteFileObject, n) {
  ...
  return new Promise((resolve, reject) => {
    const fileWorkingObject = {
      ...
      localFile: option.localPath + '/' + remoteFileObject.name,
      remoteFile: option.remotePath + '/' + remoteFileObject.name
    }
...
exports.outputBegin = function (fileWorkingObject) {
  return new Promise((resolve, reject) => {
    if (!fileWorkingObject.quiet) {
      ...
      console.info(util.format(msg, fileWorkingObject.fileNum, fileWorkingObject.remoteFile))
    }
    resolve(fileWorkingObject)
  })
}
