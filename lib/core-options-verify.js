  ...
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.host === '' ||
      ...
      if (!workingObject.validatedOption.quiet) {
        console.warn(util.format('Warning: host is undefined, defaulting to %s.', conf.DEFAULT_HOSTNAME))
      }
...
exports.verifyUser = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.username === '' ||
      ...
      reject(new Error('Error: username is undefined.'))
    } else {
...
exports.verifyPassword = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.password === '' ||
      ...
      reject(new Error('Error: password is undefined.'))
    } else {
...
exports.verifySkipIfExists = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.skipIfExists === undefined ||
      ...
      if (!workingObject.validatedOption.quiet) {
        console.warn(util.format('Warning: skipIfExists is undefined, defaulting to %s.', workingObject.validatedOption.skipIfExists))
      }
      resolve(workingObject)
...
exports.verifySkipIfNotExists = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.skipIfNotExists === undefined ||
      ...
      if (!workingObject.validatedOption.quiet) {
        console.warn(util.format('Warning: skipIfNotExists is undefined, defaulting to %s.', workingObject.validatedOption.skipIfNotExists))
      }
      resolve(workingObject)
...
exports.verifySkipIfNewer = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.skipIfNewer === undefined ||
      ...
      if (!workingObject.validatedOption.quiet) {
        console.warn(util.format('Warning: skipIfNewer is undefined, defaulting to %s.', workingObject.validatedOption.skipIfNewer))
      }
      resolve(workingObject)
...
exports.verifySkipIfOlder = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.skipIfOlder === undefined ||
      ...
      if (!workingObject.validatedOption.quiet) {
        console.warn(util.format('Warning: skipIfOlder is undefined, defaulting to %s.', workingObject.validatedOption.skipIfOlder))
      }
      resolve(workingObject)
...
exports.verifySkipIfSameAge = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.skipIfSameAge === undefined ||
      ...
      if (!workingObject.validatedOption.quiet) {
        console.warn(util.format('Warning: skipIfSameAge is undefined, defaulting to %s.', workingObject.validatedOption.skipIfSameAge))
      }
      resolve(workingObject)
...
exports.verifySkipIfBigger = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.skipIfBigger === undefined ||
      ...
      if (!workingObject.validatedOption.quiet) {
        console.warn(util.format('Warning: skipIfBigger is undefined, defaulting to %s.', workingObject.validatedOption.skipIfBigger))
      }
      resolve(workingObject)
...
exports.verifySkipIfSmaller = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.skipIfSmaller === undefined ||
      ...
      if (!workingObject.validatedOption.quiet) {
        console.warn(util.format('Warning: skipIfSmaller is undefined, defaulting to %s.', workingObject.validatedOption.skipIfSmaller))
      }
      resolve(workingObject)
...
exports.verifySkipIfSameSize = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.skipIfSameSize === undefined ||
      ...
      if (!workingObject.validatedOption.quiet) {
        console.warn(util.format('Warning: skipIfSameSize is undefined, defaulting to %s.', workingObject.validatedOption.skipIfSameSize))
      }
      resolve(workingObject)
...
exports.verifyPort = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.port === '' ||
      ...
      if (!workingObject.validatedOption.quiet) {
        console.info(util.format('Info: port is undefined, defaulting to %d.', workingObject.validatedOption.port))
      }
      resolve(workingObject)
...
exports.verifyRemotePath = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.remotePath === '' ||
      ...
      if (!workingObject.validatedOption.quiet) {
        console.warn(util.format('Warning: remotePath is undefined, defaulting to current directory. [%s]', workingObject.validatedOption.remotePath))
      }
      resolve(workingObject)
    } else {
...
exports.verifyLocalPath = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.localPath === '' ||
      ...
      if (!workingObject.validatedOption.quiet) {
        console.warn(util.format('Warning: localPath is undefined, defaulting to current directory. [%s]', workingObject.validatedOption.localPath))
      }
      resolve(workingObject)
    } else {
