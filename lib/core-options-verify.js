...
exports.verifyHost = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.host === '' ||
      ...
      if (!workingObject.validatedOption.quiet) { console.warn(util.format('Warning: host undefined, defaulting to %s.', conf.DEFAULT_HOSTNAME)) }
...
exports.verifySkipIfExists = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.skipIfExists === undefined) {
      ...
      if (!workingObject.validatedOption.quiet) { console.warn(util.format('Warning: skipIfExists undefined, defaulting to %s.', workingObject.validatedOption.skipIfExists)) }
      resolve(workingObject)
...
exports.verifySkipIfNotExists = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.skipIfNotExists === undefined) {
      ...
      if (!workingObject.validatedOption.quiet) { console.warn(util.format('Warning: skipIfNotExists undefined, defaulting to %s.', workingObject.validatedOption.skipIfNotExists)) }
      resolve(workingObject)
...
exports.verifySkipIfNewer = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.skipIfNewer === undefined) {
      ...
      if (!workingObject.validatedOption.quiet) { console.warn(util.format('Warning: skipIfNewer undefined, defaulting to %s.', workingObject.validatedOption.skipIfNewer)) }
      resolve(workingObject)
...
exports.verifySkipIfOlder = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.skipIfOlder === undefined) {
      ...
      if (!workingObject.validatedOption.quiet) { console.warn(util.format('Warning: skipIfOlder undefined, defaulting to %s.', workingObject.validatedOption.skipIfOlder)) }
      resolve(workingObject)
...
exports.verifySkipIfSameAge = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.skipIfSameAge === undefined) {
      ...
      if (!workingObject.validatedOption.quiet) { console.warn(util.format('Warning: skipIfSameAge undefined, defaulting to %s.', workingObject.validatedOption.skipIfSameAge)) }
      resolve(workingObject)
...
exports.verifySkipIfBigger = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.skipIfBigger === undefined) {
      ...
      if (!workingObject.validatedOption.quiet) { console.warn(util.format('Warning: skipIfBigger undefined, defaulting to %s.', workingObject.validatedOption.skipIfBigger)) }
      resolve(workingObject)
...
exports.verifySkipIfSmaller = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.skipIfSmaller === undefined) {
      ...
      if (!workingObject.validatedOption.quiet) { console.warn(util.format('Warning: skipIfSmaller undefined, defaulting to %s.', workingObject.validatedOption.skipIfSmaller)) }
      resolve(workingObject)
...
exports.verifySkipIfSameSize = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.skipIfSameSize === undefined) {
      ...
      if (!workingObject.validatedOption.quiet) { console.warn(util.format('Warning: skipIfSameSize undefined, defaulting to %s.', workingObject.validatedOption.skipIfSameSize)) }
      resolve(workingObject)
...
exports.verifyPort = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.port === '' ||
      ...
      if (!workingObject.validatedOption.quiet) { console.info(util.format('Info: port undefined, defaulting to %d.', workingObject.validatedOption.port)) }
      resolve(workingObject)
...
exports.verifyRemotePath = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.remotePath === '' ||
      ...
      if (!workingObject.validatedOption.quiet) { console.warn(util.format('Warning: remotePath undefined, defaulting to current directory. [%s]', workingObject.validatedOption.remotePath)) }
      resolve(workingObject)
    } else {
...
exports.verifyLocalPath = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.localPath === '' ||
      ...
      if (!workingObject.validatedOption.quiet) { console.warn(util.format('Warning: localPath undefined, defaulting to current directory. [%s]', workingObject.validatedOption.localPath)) }
      resolve(workingObject)
    } else {
  ...
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.keepTimestamp === undefined) {
      ...
      if (u.isBoolean(workingObject.userOption.keepTimestamp)) {
        ...
        reject(new Error(
          util.format('Error: keepTimestamp is not a boolean value [%s].', workingObject.userOption.keepTimestamp)
        ))
      }
    } else {
