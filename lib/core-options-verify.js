...
exports.verifyPostProcessing = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.postProcessing === '' ||
      workingObject.userOption.postProcessing === null ||
      workingObject.userOption.postProcessing === undefined) {
...
exports.verifyPostProcessingOptions = function (workingObject) {
  return new Promise((resolve, reject) => {
    if (workingObject.userOption.postProcessingOptions === '' ||
      workingObject.userOption.postProcessingOptions === null ||
      workingObject.userOption.postProcessingOptions === undefined) {
