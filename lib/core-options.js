    ...
    verifyOptionsSkipIfExists: function (workingObject) {
        return new Promise((resolve, reject) => {
            if (workingObject.userOption.skipIfExists == undefined) {
                workingObject.validatedOption.skipIfExists = true;
    ...
    verifyOptionsSkipIfNotExists: function (workingObject) {
        return new Promise((resolve, reject) => {
            if (workingObject.userOption.skipIfNotExists == undefined) {
                workingObject.validatedOption.skipIfNotExists = true;
                console.warn(
                    util.format("Warning: skipIfNotExists undefined, defaulting to %s.", workingObject.validatedOption.skipIfNotExists)
                );
                resolve(workingObject);
    ...
    verifyOptionsPort: function (workingObject) {
        return new Promise((resolve, reject) => {
            if (workingObject.userOption.port == "" ||
                ...
                workingObject.validatedOption.port = 22;
                console.warn(
                    util.format("Warning: port undefined, defaulting to %d.", workingObject.validatedOption.port)
                );
                resolve(workingObject);
            } else {
                workingObject.validatedOption.port = workingObject.userOption.port;
                resolve(workingObject);
            }
        });
    },
    verifyOptionsRemotePath: function (workingObject) {
        return new Promise((resolve, reject) => {
            if (workingObject.userOption.remotePath == "" ||
                ...
                workingObject.validatedOption.remotePath = '.';
                console.warn(
                    util.format("Warning: remotePath undefined, defaulting to current directory. [%s]", workingObject.validatedOption.remotePath)
                );
                resolve(workingObject);
            } else {
    ...
    verifyOptionsLocalPath: function (workingObject) {
        return new Promise((resolve, reject) => {
            if (workingObject.userOption.localPath == "" ||
                ...
                workingObject.validatedOption.localPath = '.';
                console.warn(
                    util.format("Warning: localPath undefined, defaulting to current directory. [%s]", workingObject.validatedOption.localPath)
                );
                resolve(workingObject);
            } else {
    ...
    verifyOptionsVerbose: function (workingObject) {
        return new Promise((resolve, reject) => {
            if (workingObject.userOption.verbose == undefined) {
                workingObject.validatedOption.verbose = false;
                resolve(workingObject);
    ...
    verifyOptionsQuiet: function (workingObject) {
        return new Promise((resolve, reject) => {
            if (workingObject.userOption.quiet == undefined) {
                workingObject.validatedOption.quiet = false;
                resolve(workingObject);
