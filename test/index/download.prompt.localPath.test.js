...
test('scp/download/prompt/localPath/+', () => {
  const expectedInfo = [
    ...
    '1 downloaded /home/testuser/data/Mock_File_1.zip ' + path.normalize('console/input/localPath/Mock_File_1.zip') + ' 2928',
    '2 downloaded /home/testuser/data/Mock_File_2.zip ' + path.normalize('console/input/localPath/Mock_File_2.zip') + ' 49453',
